...
import com.example.playlistmaker.databinding.ItemPlaylistPlayerScreenBinding
import com.example.playlistmaker.data.db.PlaylistEntity

class PlaylistsAdapterForPlayerScreen(
    private val onPlaylistClicked: (PlaylistEntity) -> Unit
) : RecyclerView.Adapter<PlaylistsAdapterForPlayerScreen.PlaylistViewHolder>() {

    private val items = mutableListOf<PlaylistEntity>()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PlaylistViewHolder {
        val inflater = LayoutInflater.from(parent.context)
        val binding = ItemPlaylistPlayerScreenBinding.inflate(inflater, parent, false)
    ...
    inner class PlaylistViewHolder(
        private val binding: ItemPlaylistPlayerScreenBinding
